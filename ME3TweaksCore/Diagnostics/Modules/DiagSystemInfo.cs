...
namespace ME3TweaksCore.Diagnostics.Modules
{
    ...
    internal class DiagSystemInfo : DiagModuleBase
    {
        internal override void RunModule(LogUploadPackage package)
        {
            ...
            if (ramInBytes == 0)
            {
                diag.AddDiagLine(@"Unable to get the read amount of physically installed ram. This may be a sign of impending hardware failure in the SMBIOS", LogSeverity.WARN);
            }
